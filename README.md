...
* [oxipng](https://github.com/shssoichiro/oxipng) ⭐ 4,179 | 🐛 35 | 🌐 Rust | 📅 2026-08-17 - Simple program for general image optimization but also works nicely with FNF Sprite Sheets.
...
* [Friday Night Funkin' Official Source Code](https://github.com/FunkinCrew/funkin) ⭐ 3,745 | 🐛 906 | 🌐 Haxe | 📅 2026-08-23 - The original open source game by The Funkin' Crew. Last updated for The Mobile Port.
...
* [Base Game FLAs](https://github.com/FunkinCrew/Funkin/tree/master/art/flashFiles) ⭐ 3,745 | 🐛 906 | 🌐 Haxe | 📅 2026-08-23 - FLAs for Friday Night' Funkin from the GitHub repository.
