...
* [oxipng](https://github.com/shssoichiro/oxipng) ⭐ 4,203 | 🐛 32 | 🌐 Rust | 📅 2026-09-02 - Simple program for general image optimization but also works nicely with FNF Sprite Sheets.
...
* [Friday Night Funkin' Official Source Code](https://github.com/FunkinCrew/funkin) ⭐ 3,748 | 🐛 908 | 🌐 Haxe | 📅 2026-09-04 - The original open source game by The Funkin' Crew. Last updated for The Mobile Port.
...
* [Codename Engine](https://github.com/YoshiCrafter29/CodenameEngine) ⭐ 473 | 🐛 65 | 🌐 Haxe | 📅 2026-09-04 - A fork of base game that provides full HScript support for advanced softcoding, along with sorted and half rewritten source for optimisation and ease of use.
  * [Codename Engine Docs](https://github.com/YoshiCrafter29/CodenameEngine/wiki) ⭐ 473 | 🐛 65 | 🌐 Haxe | 📅 2026-09-04 - Codename Engine modding documenation.

* [FPS Plus](https://github.com/ThatRozebudDude/FPS-Plus-Public) ⭐ 161 | 🐛 2 | 🌐 Haxe | 📅 2026-09-04 - A fork of Funkin', as the name suggests, with higher framerate, better input system, rebindable keys and more. [B-Side Redux](https://gamebanana.com/mods/42724) was made on this engine.
...
* [Base Game FLAs](https://github.com/FunkinCrew/Funkin/tree/master/art/flashFiles) ⭐ 3,748 | 🐛 908 | 🌐 Haxe | 📅 2026-09-04 - FLAs for Friday Night' Funkin from the GitHub repository.
