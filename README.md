...
# Awesome Friday Night Funkin' Resources with stars
...
Unsure what to contribute? Check out the `good first issue` [tagged GitHub issues](https://github.com/FunkinCrew/funkin-resources/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) ⭐ 239 | 🐛 31 | 🌐 JavaScript | 📅 2026-05-23 and read our [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE_OF_CONDUCT.md)!
...
* [Aseprite](https://www.aseprite.org/) - Animated sprite editor and pixel art tool.
  * [Aseprite JSON to XML](https://github.com/MaybeMaru/Aseprite-JSON-to-XML) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2023-07-24 - Converter from Aseprite's JSON format to Sparrow XML that is compatible with Funkin'. (Note: Aseprite is getting support on engines such as Codename Engine, therefore you won't need this for those engines anymore)
...
* [oxipng](https://github.com/shssoichiro/oxipng) ⭐ 4,168 | 🐛 34 | 🌐 Rust | 📅 2026-08-17 - Simple program for general image optimization but also works nicely with FNF Sprite Sheets.
...
* [Example lua script of atlas spritesheets (PSYCH ENGINE)](https://github.com/MarkimusZer0/SmokeyTextureAtlas-Example/blob/main/ExampleScript/spawnAtlasPico.lua) ⭐ 1 | 🐛 0 | 🌐 Lua | 📅 2023-07-26 - Example script showing how to use Atlas sprites in Lua.
...
* [Friday Night Funkin' Official Source Code](https://github.com/FunkinCrew/funkin) ⭐ 3,738 | 🐛 935 | 🌐 Haxe | 📅 2026-08-16 - The original open source game by The Funkin' Crew. Last updated for The Mobile Port.
...
* [Psych Engine](https://github.com/ShadowMario/FNF-PsychEngine) ⚠️ Archived - A fork of base game which includes new quality-of-life changes, performance improvements, and Lua-based mod tools. Popular and well-documented.
  * [Psych Engine Docs](https://github.com/ShadowMario/FNF-PsychEngine/wiki) ⚠️ Archived - Psych Engine modding documentation.
  * [Another alternative wiki for Psych Engine](https://github.com/Meme1079/PsychWiki/wiki) ⭐ 51 | 🐛 1 | 🌐 Lua | 📅 2026-04-08 - Made by [Meme1079](https://github.com/Meme1079) and contributors.
  * [Troll Engine](https://github.com/riconuts/troll-engine) ⭐ 0 | 🐛 0 | 📅 2024-09-03 - A competitive fork of Psych Engine made for the Tails gets Trolled mod. Supports HScripting and has modchart capabilities with a system similar to Andromeda's.
...
* [Codename Engine](https://github.com/YoshiCrafter29/CodenameEngine) ⭐ 469 | 🐛 65 | 🌐 Haxe | 📅 2026-08-17 - A fork of base game that provides full HScript support for advanced softcoding, along with sorted and half rewritten source for optimisation and ease of use.
  * [Codename Engine Docs](https://github.com/YoshiCrafter29/CodenameEngine/wiki) ⭐ 469 | 🐛 65 | 🌐 Haxe | 📅 2026-08-17 - Codename Engine modding documenation.

* [FPS Plus](https://github.com/ThatRozebudDude/FPS-Plus-Public) ⭐ 159 | 🐛 3 | 🌐 Haxe | 📅 2026-08-17 - A fork of Funkin', as the name suggests, with higher framerate, better input system, rebindable keys and more. [B-Side Redux](https://gamebanana.com/mods/42724) was made on this engine.
...
* [Crow Engine](https://github.com/EyeDaleHim/Crow-Engine) ⭐ 30 | 🐛 0 | 🌐 Haxe | 📅 2025-12-27 - A 1:1 recreation of Base Game, introduces extreme performance upgrades, source code easier to work with.

* [Super Engine](https://github.com/superpowers04/Super-Engine) ⭐ 24 | 🐛 8 | 🌐 Haxe | 📅 2026-05-23 - A fork of Kade Engine that features revamped menus, mod support and online functionality.

* [Altronix Engine](https://github.com/Altronix-Team/FNF-AltronixEngine) ⭐ 11 | 🐛 0 | 🌐 Haxe | 📅 2025-03-19 - An engine that provides the support for creating localizations into different languages and HScript modding support with Polymod HScript classes and small script files. Also, engine has integration with GameJolt with achievements.
...
* *Modding+* - An archived engine with HScript support with the intention of easy customization and enhanced gameplay options.
  * [Disappointing Plus](https://github.com/AFunkinDisappointment/DisappointingPlus) ⭐ 14 | 🐛 0 | 🌐 Haxe | 📅 2026-08-06 - A fork of Modding+ with additional features such as framerate adjustment, camera movement whenever a character sings, and an improved character swap function.
...
* [FNF LÖVE](https://github.com/Stilic/FNF-LOVE) ⭐ 56 | 🐛 0 | 🌐 Lua | 📅 2026-08-04 - A Lua recreation of FNF within the LÖVE2D framework. Can compile for Nintendo Switch Homebrew.
...
* [FunkiniOS](https://github.com/hadobedo/FunkiniOS) ⭐ 33 | 🐛 11 | 🌐 Haxe | 📅 2022-08-09 - A port of FNF to iOS devices, requires sideloading.
* [Funkin3D](https://github.com/GuglioIsStupid/Funkin3D) ⭐ 30 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - A 3DS de-make of FNF made in LÖVEPOTION.
* [PydayNightFunkin](https://github.com/Square789/PydayNightFunkin) ⭐ 14 | 🐛 9 | 🌐 Python | 📅 2024-06-06 - A recreation of FNF in Python, allowing for quick changeability! Tries to be painlessly readable and is somewhat documented.
* [BS Engine Mobile](https://github.com/MatheusSilver/BS-Engine-Mobile-Legacy) ⚠️ Archived - A port of FNF that work in Android with optimizations. One of the most famous android FNF engines.
* [Funkin' Mobile](https://github.com/FNF-Mod-Porting/Funkin) ⭐ 2 | 🐛 0 | 🌐 Haxe | 📅 2024-03-14 - A heavy wip fork of the base game but rewritten for mobile devices, inspired by luckydog7's port of the game to android devices.
...
* [HaxeFlixel Demos](https://haxeflixel.com/demos/) - Collection of demos for HaxeFlixel, designed to introduce beginners to the framework.
  * [GitHub repository for abovementioned demos](https://github.com/HaxeFlixel/flixel-demos) ⭐ 465 | 🐛 24 | 🌐 Haxe | 📅 2026-07-03
...
* [HaxeFlixel's Tutorial Game (TurnBasedRPG)](https://haxeflixel.com/documentation/tutorial/) - A really nifty tutorial that goes step-by-step on teaching how to make a game, comes with pre-made assets for you to use as well.
  * [GitHub source code for TurnBasedRPG](https://github.com/HaxeFlixel/flixel-demos/tree/dev/Tutorials/TurnBasedRPG) ⭐ 465 | 🐛 24 | 🌐 Haxe | 📅 2026-07-03
...
* [Base Game FLAs](https://github.com/FunkinCrew/Funkin/tree/master/art/flashFiles) ⭐ 3,738 | 🐛 935 | 🌐 Haxe | 📅 2026-08-16 - FLAs for Friday Night' Funkin from the GitHub repository.
...
* [Moonchart](https://github.com/MaybeMaru/moonchart) ⭐ 54 | 🐛 6 | 🌐 Haxe | 📅 2026-07-30 - Haxe library able to manage and convert charts made between multiple rhythm games to files usable in many Friday Night Funkin' versions and engines.
