...
Unsure what to contribute? Check out the `good first issue` [tagged GitHub issues](https://github.com/FunkinCrew/funkin-resources/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) ⭐ 242 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-23 and read our [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE_OF_CONDUCT.md)!
...
* [oxipng](https://github.com/shssoichiro/oxipng) ⭐ 4,211 | 🐛 33 | 🌐 Rust | 📅 2026-09-02 - Simple program for general image optimization but also works nicely with FNF Sprite Sheets.
...
* [Friday Night Funkin' Official Source Code](https://github.com/FunkinCrew/funkin) ⭐ 3,752 | 🐛 914 | 🌐 Haxe | 📅 2026-09-04 - The original open source game by The Funkin' Crew. Last updated for The Mobile Port.
...
* [Codename Engine](https://github.com/YoshiCrafter29/CodenameEngine) ⭐ 474 | 🐛 65 | 🌐 Haxe | 📅 2026-09-06 - A fork of base game that provides full HScript support for advanced softcoding, along with sorted and half rewritten source for optimisation and ease of use.
  * [Codename Engine Docs](https://github.com/YoshiCrafter29/CodenameEngine/wiki) ⭐ 474 | 🐛 65 | 🌐 Haxe | 📅 2026-09-06 - Codename Engine modding documenation.
...
* [Base Game FLAs](https://github.com/FunkinCrew/Funkin/tree/master/art/flashFiles) ⭐ 3,752 | 🐛 914 | 🌐 Haxe | 📅 2026-09-04 - FLAs for Friday Night' Funkin from the GitHub repository.
