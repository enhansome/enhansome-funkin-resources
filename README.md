...
* [oxipng](https://github.com/shssoichiro/oxipng) ⭐ 4,226 | 🐛 32 | 🌐 Rust | 📅 2026-09-02 - Simple program for general image optimization but also works nicely with FNF Sprite Sheets.
...
* [Friday Night Funkin' Official Source Code](https://github.com/FunkinCrew/funkin) ⭐ 3,761 | 🐛 927 | 🌐 Haxe | 📅 2026-09-16 - The original open source game by The Funkin' Crew. Last updated for The Mobile Port.
...
* [Codename Engine](https://github.com/YoshiCrafter29/CodenameEngine) ⭐ 479 | 🐛 69 | 🌐 Haxe | 📅 2026-09-17 - A fork of base game that provides full HScript support for advanced softcoding, along with sorted and half rewritten source for optimisation and ease of use.
  * [Codename Engine Docs](https://github.com/YoshiCrafter29/CodenameEngine/wiki) ⭐ 479 | 🐛 69 | 🌐 Haxe | 📅 2026-09-17 - Codename Engine modding documenation.
...
* [Base Game FLAs](https://github.com/FunkinCrew/Funkin/tree/master/art/flashFiles) ⭐ 3,761 | 🐛 927 | 🌐 Haxe | 📅 2026-09-16 - FLAs for Friday Night' Funkin from the GitHub repository.
